class J extends Piece {
  ...
  public J(int x, int y, boolean active) {
    super(x, y, active);
  ...
  public void rotation() {
    if (this.active) {
      ...
      if (this.pos==0) {
        ...
        portions[0].setPosition(portions[0].x, portions[0].y+30);
        portions[1].setPosition(portions[1].x-30, portions[1].y);
        portions[2].setPosition(portions[2].x-60, portions[2].y-30);
        portions[3].setPosition(portions[3].x-30, portions[3].y-60);
        this.pos=2;
      } else if (pos==2) {
        ...
        portions[3].setPosition(portions[3].x+60, portions[3].y);
        this.pos=3;
      } else if (pos==3) {
        portions[0].setPosition(portions[0].x-30, portions[0].y-30);
        portions[1].setPosition(portions[1].x, portions[1].y);
        portions[2].setPosition(portions[2].x+30, portions[2].y+30);
        portions[3].setPosition(portions[3].x, portions[3].y+60);
        this.pos=0;
      }
    }
  }
